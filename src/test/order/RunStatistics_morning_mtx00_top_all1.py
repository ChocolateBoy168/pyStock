...
def run():
	...
	morning_strategy_sources = [
		'StraBvm[root(multi_b6)]        [bvm(aa_noBlock_1)][fomSumV(aa_1)][fomKma(aa_slope_in_60_20_10_5_out_60)][containNight(true)]',#test
		'StraBvm[root(multi_b6)]        [bvm(aa_noBlock_1)][fomSumV(aa_2)][fomKma(aa_slope_in_60_20_10_5_out_60)][containNight(true)]',#test
		'StraBvm[root(multi_b6)]        [bvm(aa_noBlock_1)][fomSumV(aa_3)][fomKma(aa_slope_in_60_20_10_5_out_60)][containNight(true)]',#test
	]
